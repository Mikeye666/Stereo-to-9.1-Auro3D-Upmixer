...
,
					"snapshot" : 					{
						...
						"snapshot" : 						{
							...
							"pluginsavedname" : "~/Documents/NYU Courseworks/Thesis/Upmixer System/Upmixer/Test System Ver 1/Kraft_Ambience_Extractor.vst",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 198.0, 148.0, 45.0, 45.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 426.0, 221.0, 184.0, 25.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 426.0, 175.5, 214.0, 40.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 426.0, 148.0, 173.0, 25.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 426.0, 323.0, 241.0, 25.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 350.0, 301.0, 24.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 350.0, 326.0, 70.0, 23.0 ],
					"style" : "",
					"text" : "bypass $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 350.0, 251.0, 24.0, 24.0 ],
					"presentation_rect" : [ 350.0, 265.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 350.0, 276.0, 70.0, 23.0 ],
					"style" : "",
					"text" : "disable $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 426.0, 273.0, 162.0, 25.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 349.0, 224.0, 70.0, 23.0 ],
					"style" : "",
					"text" : "wclose"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 349.0, 151.0, 70.0, 23.0 ],
					"style" : "",
					"text" : "plug"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 274.0, 395.0, 100.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 10.0, 9.0, 589.0, 99.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 62.0, 126.0, 62.0, 22.0 ],
					"style" : "",
					"text" : "X.player~",
					"varname" : "X.player~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 20.0, 126.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"style" : "",
					"text" : "2",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 325.5, 151.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"style" : "",
					"text" : "1",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
...
,
		"dependency_cache" : [ 			{
				...
				"patcherrelativepath" : "../../../../../../../Shared/Max 7/Examples/sampling/SoundPlayer/lib",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
